...
extern DMA_HandleTypeDef hI2c1Dmarx;
extern DMA_HandleTypeDef hI2c1Dmatx;
/**
  * @}
  */
    ...
    if(hi2c->Instance==I2C1)
    {
        ...
        */ 		 
        ...
        XT_IO_Option_Assigned(EVB_I2C1_SDA_IO_IDX,	EVB_I2C1_SDA_IO_CFG, PADI_PULLUP);
			...
			//DMA ModeDMA Handshaking Interface:INDEX 8 and INDEX 9 of CFG1 I2C1 TX RX cfg0 for I2C1
        HAL_I2C_DMAHSIFConfig(hi2c, &hI2c1Dmarx, &hI2c1Dmatx, 
                              I2C1_RXD_DMAHSIF_IDX, I2C1_TXD_DMAHSIF_IDX, I2C1_RXD_DMAHSIF_CFG, I2C1_TXD_DMAHSIF_CFG);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
	if(hi2c->Instance==I2C1)
	{
		...
		/**mapping IO  I2C GPIO Configuration ***
		IO38     ------> I2C1 SCK
		IO39     ------> I2C1 SDA
		*/
