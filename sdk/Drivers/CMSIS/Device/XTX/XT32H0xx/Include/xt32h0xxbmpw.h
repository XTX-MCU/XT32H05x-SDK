/**
  ...
  *          definitions and memory mapping for xt32h0xxbmpw devices.
  *
  *          This file contains:
...
/** @addtogroup xt32h0xxbmpw
  * @{
  */

#ifndef XT32H0XXBMPW_H
#define XT32H0XXBMPW_H
...
#define __MPU_PRESENT             0U /*!< xt32h0xxbmpw  provides an MPU                    */
#define __VTOR_PRESENT            1U /*!< Vector  Table  Register supported             */
#define __NVIC_PRIO_BITS          2U /*!< xt32h0xxbmpw uses 2 Bits for the Priority Levels */
...
/**
 * @brief xt32h0xxbmpw Interrupt Number Definition, according to the selected device
...
/*****************  Cortex-M0+ Processor Exceptions Numbers  ******************/
  ...
  PendSV_IRQn                 = -2,
  SysTick_IRQn                = -1,
/*****************  XT32H0XXBMPW specific Interrupt Numbers  ******************/
  DMA1_IRQn                   = 0,
  WDTW_IRQn                   = 1,
  ADC_EOC_IRQn                = 2,
  RTC_IRQn                    = 3,
...
typedef struct
{
  ...
  __IO uint32_t NSMW_SET_WHV;           /*!< Address offset: 0x10 */
} FLASH_TypeDef;
...
#define FLASH_OPT_MAXPRNUM_Msk                              (0x1UL << FLASH_OPT_MAXPRNUM_Pos)
...
#define FLASH_TMR_RD_Msk                                    (0x1ffUL << FLASH_TMR_RD_Pos)
#define FLASH_TMR_RD                                        FLASH_TMR_RD_Msk

/******************  Bits definition for FLASH_NSMW_SET_WHV  ******************/
...
#define SYSCFG_AFCRES_RFDIV_Msk                             (0xffUL << SYSCFG_AFCRES_RFDIV_Pos)
