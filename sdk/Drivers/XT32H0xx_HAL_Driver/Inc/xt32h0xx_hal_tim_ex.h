...
#ifndef XT32H0xx_HAL_TIM_EX_H
#define XT32H0xx_HAL_TIM_EX_H
...
#define TIM_TIM1_TI4_GPIO                     0x00000000U                       /* !< TIM1_TI4 is connected to GPIO */
//#if defined(COMP3)
//#define TIM_TIM1_TI4_COMP4                    0x01000000U                       /* !< TIM1_TI4 is connected to COMP4 OUT */
//#endif /* COMP3 */
...
//#if defined(COMP3)
//#define TIM_TIM2_TI4_COMP4                    0x01000000U                       /* !< TIM2_TI4 is connected to COMP4 OUT */
//#endif /* COMP3 */
#endif /* TIM2 */
...
/** @defgroup TIM_EC_TIMAG_ID  Adv timers and general timers index 
  * @{
  */
#define TIM_IMX_TIMA1_ID                (0)  
#define TIM_IMX_TIMA2_ID                (1)  
#define TIM_IMX_TIMG1_ID                (2)  
#define TIM_IMX_TIMG2_ID                (3)  
#define TIM_IMX_TIMG3_ID                (4)  
#define TIM_IMX_TIMG4_ID                (5)  
/**
  * @}
  */

/** @defgroup TIM_EC_TIMAG_INPUT_SRC  Adv timers and general timers input sources 
  * @{
  */
#define TIM_IMX_SRC_TIMA1           (0)  
#define TIM_IMX_SRC_TIMA2           (1)  
#define TIM_IMX_SRC_TIMG1           (2)  
#define TIM_IMX_SRC_TIMG2           (3)  
#define TIM_IMX_SRC_TIMG3           (4)  
#define TIM_IMX_SRC_TIMG4           (5)  
#define TIM_IMX_SRC_NONE            (6)  
/**
  * @}
  */
/** @defgroup TIM_EC_TIMAG_IC_ID  Adv timers and general timers input channel index 
  * @{
  */
#define TIM_IC_CH1_ID                (0)  
#define TIM_IC_CH2_ID                (1)  
#define TIM_IC_CH3_ID                (2)  
#define TIM_IC_CH4_ID                (3)  
#define TIM_IC_ETR_ID                (4)  
/**
  * @}
  */

/** @defgroup TIM_EC_TIMAG_OUTPUT_CH_ID  Adv timers and general timers output config channel index
  * @{
  */
#define TIM_OC_CH1_ID                  (0)  
#define TIM_OC_CH2_ID                  (1)  
/**
  * @}
  */

/** @defgroup TIM_EC_TIMAG_OUTPUT_CFG  Adv timers and general timers output config complementary or single-ended 
  * @{
  */
#define TIM_OC_COMPLEMENTARY        (0)  
#define TIM_OC_SINGLE_ENDED         (1)  
/**
  * @}
  */
