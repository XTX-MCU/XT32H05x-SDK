...
#ifndef XT32H0xx_LL_UTILS_H
#define XT32H0xx_LL_UTILS_H
...
/**
  ...
  */
/* Exported types ------------------------------------------------------------*/
/** @defgroup UTILS_LL_Exported_Types UTILS Exported Types
  * @{
  */
/**
...
typedef struct
{
  uint32_t PLLM;   /*!< Division factor for PLL VCO input clock.
                        This parameter can be a value of @ref RCC_PLLM_Clock_Divider */

  uint32_t PLLN;   /*!< Multiplication factor for PLL VCO output clock @ref RCC_PLLN_Clock_Divider.
                        This parameter must be a number between Min_Data = 8 and Max_Data = 86 */

  uint32_t PLLR;   /*!< Division for the main system clock.
                        This parameter can be a value of @ref RCC_PLLR_Clock_Divider */
...
/** @defgroup UTILS_EC_PACKAGETYPE PACKAGE TYPE
  * @{
  */
#define LL_UTILS_PACKAGETYPE_QFN44_GP      (0x00000000U)                       /*!< UFQFPN44 general purpose (GP) package type          */
#define LL_UTILS_PACKAGETYPE_QFN44_PD      (0x00000001U)                       /*!< UFQFPN44 Power Delivery (PD)                        */
