...
#ifndef __XT32H0xx_LL_TIM_H
#define __XT32H0xx_LL_TIM_H
...
#if defined(TIM1) || defined(TIM2) || defined(TIMG1) || defined(TIMG2) || defined(TIMG3) || defined(TIMG4)
...
/* Exported types ------------------------------------------------------------*/
/** @defgroup TIM_LL_Exported_Types TIM Exported Types
  * @{
  */
...
typedef struct
{
  ...
  uint32_t RepetitionCounter;  /*!< Specifies the repetition counter value. Each time the REP downcounter
                                   reaches zero, an update event is generated and counting restarts
                                   from the REP value (N).
...
typedef struct
{
  ...
  uint32_t OCDeadTime;    /*!< TIM dead Time, This parameter can be a number between Min_Data = 0x00 and Max_Data = 0xFF */

  uint32_t OCNDeadTime;   /*!< TIM dead Time, This parameter can be a number between Min_Data = 0x00 and Max_Data = 0xFF */
...
/**
  * @brief  BKDT (Break and Dead Time) structure definition
  */
typedef struct
{
...
/**
  ...
  * @rmtoll CTRL1          CEN           LL_TIM_EnableCounter
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableCounter(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->CTRL1, TIM_CR1_CEN);
}

/**
  * @brief  Disable timer counter.
  * @rmtoll CTRL1          CEN           LL_TIM_DisableCounter
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableCounter(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->CTRL1, TIM_CR1_CEN);
}

/**
  * @brief  Indicates whether the timer counter is enabled.
  * @rmtoll CTRL1          CEN           LL_TIM_IsEnabledCounter
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledCounter(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->CTRL1, TIM_CR1_CEN) == (TIM_CR1_CEN)) ? 1UL : 0UL);
}

/**
  * @brief  Enable update event generation.
  * @rmtoll CTRL1          UDIS          LL_TIM_EnableUpdateEvent
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableUpdateEvent(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->CTRL1, TIM_CR1_UDIS);
}

/**
  * @brief  Disable update event generation.
  * @rmtoll CTRL1          UDIS          LL_TIM_DisableUpdateEvent
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableUpdateEvent(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->CTRL1, TIM_CR1_UDIS);
}

/**
  * @brief  Indicates whether update event generation is enabled.
  * @rmtoll CTRL1          UDIS          LL_TIM_IsEnabledUpdateEvent
  * @param  TIMx Timer instance
  * @retval Inverted state of bit (0 or 1).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledUpdateEvent(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->CTRL1, TIM_CR1_UDIS) == (uint32_t)RESET) ? 1UL : 0UL);
}
...
/**
  ...
  * @rmtoll CTRL1          URS           LL_TIM_SetUpdateSource
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->CTRL1, TIM_CR1_URS, UpdateSource);
}

/**
  * @brief  Get actual event update source
  * @rmtoll CTRL1          URS           LL_TIM_GetUpdateSource
  * @param  TIMx Timer instance
...
{
  return (uint32_t)(READ_BIT(TIMx->CTRL1, TIM_CR1_URS));
}

/**
  * @brief  Set one pulse mode (one shot v.s. repetitive).
  * @rmtoll CTRL1          OPM           LL_TIM_SetOnePulseMode
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->CTRL1, TIM_CR1_OPM, OnePulseMode);
}

/**
  * @brief  Get actual one pulse mode.
  * @rmtoll CTRL1          OPM           LL_TIM_GetOnePulseMode
  * @param  TIMx Timer instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_TIM_ONEPULSEMODE_SINGLE
  *         @arg @ref LL_TIM_ONEPULSEMODE_REPETITIVE
...
{
  return (uint32_t)(READ_BIT(TIMx->CTRL1, TIM_CR1_OPM));
}
...
/**
  ...
  * @rmtoll CTRL1          DIR           LL_TIM_SetCounterMode\n
  *         CTRL1          CMS           LL_TIM_SetCounterMode
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->CTRL1, (TIM_CR1_DIR | TIM_CR1_CMS), CounterMode);
}
...
/**
  ...
  *       check whether or not the counter mode selection feature is supported
  *       by a timer instance.
  * @rmtoll CTRL1          DIR           LL_TIM_GetCounterMode\n
  *         CTRL1          CMS           LL_TIM_GetCounterMode
  * @param  TIMx Timer instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_TIM_COUNTERMODE_UP
  *         @arg @ref LL_TIM_COUNTERMODE_DOWN
...
__STATIC_INLINE uint32_t LL_TIM_GetCounterMode(TIM_TypeDef *TIMx)
{
  ...
  counter_mode = (uint32_t)(READ_BIT(TIMx->CTRL1, TIM_CR1_CMS));

  if (counter_mode == 0U)
  {
    counter_mode = (uint32_t)(READ_BIT(TIMx->CTRL1, TIM_CR1_DIR));
  }
...
/**
  * @brief  Enable auto-reload (PRD) preload.
  * @rmtoll CTRL1          ARPE          LL_TIM_EnableARRPreload
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableARRPreload(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->CTRL1, TIM_CR1_ARPE);
}

/**
  * @brief  Disable auto-reload (PRD) preload.
  * @rmtoll CTRL1          ARPE          LL_TIM_DisableARRPreload
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableARRPreload(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->CTRL1, TIM_CR1_ARPE);
}

/**
  * @brief  Indicates whether auto-reload (PRD) preload is enabled.
  * @rmtoll CTRL1          ARPE          LL_TIM_IsEnabledARRPreload
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledARRPreload(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->CTRL1, TIM_CR1_ARPE) == (TIM_CR1_ARPE)) ? 1UL : 0UL);
}
...
/**
  ...
  *       instance.
  * @rmtoll CTRL1          CKD           LL_TIM_SetClockDivision
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->CTRL1, TIM_CR1_CKD, ClockDivision);
}
...
/**
  ...
  *       whether or not the clock division feature is supported by the timer
  *       instance.
  * @rmtoll CTRL1          CKD           LL_TIM_GetClockDivision
  * @param  TIMx Timer instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_TIM_CLOCKDIVISION_DIV1
  *         @arg @ref LL_TIM_CLOCKDIVISION_DIV2
...
{
  return (uint32_t)(READ_BIT(TIMx->CTRL1, TIM_CR1_CKD));
}
...
/**
  ...
  * @rmtoll CNTR          CNTR           LL_TIM_SetCounter
  * @param  TIMx Timer instance
  * @param  Counter Counter value (between Min_Data=0 and Max_Data=0xFFFF or 0xFFFFFFFF)
  */
__STATIC_INLINE void LL_TIM_SetCounter(TIM_TypeDef *TIMx, uint32_t Counter)
{
  WRITE_REG(TIMx->CNTR, Counter);
}
...
/**
  ...
  * @note Macro IS_TIM_32B_COUNTER_INSTANCE(TIMx) can be used to check
  *       whether or not a timer instance supports a 32 bits counter.
  * @rmtoll CNTR          CNTR           LL_TIM_GetCounter
  * @param  TIMx Timer instance
  * @retval Counter value (between Min_Data=0 and Max_Data=0xFFFF or 0xFFFFFFFF)
  */
__STATIC_INLINE uint32_t LL_TIM_GetCounter(TIM_TypeDef *TIMx)
{
  return (uint32_t)(READ_REG(TIMx->CNTR));
}

/**
  * @brief  Get the current direction of the counter
  * @rmtoll CTRL1          DIR           LL_TIM_GetDirection
  * @param  TIMx Timer instance
  * @retval Returned value can be one of the following values:
...
{
  return (uint32_t)(READ_BIT(TIMx->CTRL1, TIM_CR1_DIR));
}

/**
  * @brief  Set the prescaler value.
  * @note The counter clock frequency CK_CNT is equal to fCK_PSC / (PSCR[15:0] + 1).
  * @note The prescaler can be changed on the fly as this control register is buffered. The new
  *       prescaler ratio is taken into account at the next update event.
  * @note Helper macro @ref __LL_TIM_CALC_PSC can be used to calculate the Prescaler parameter
  * @rmtoll PSCR          PSCR           LL_TIM_SetPrescaler
  * @param  TIMx Timer instance
  * @param  Prescaler between Min_Data=0 and Max_Data=65535
  */
__STATIC_INLINE void LL_TIM_SetPrescaler(TIM_TypeDef *TIMx, uint32_t Prescaler)
{
  WRITE_REG(TIMx->PSCR, Prescaler);
}

/**
  * @brief  Get the prescaler value.
  * @rmtoll PSCR          PSCR           LL_TIM_GetPrescaler
  * @param  TIMx Timer instance
  * @retval  Prescaler value between Min_Data=0 and Max_Data=65535
  */
__STATIC_INLINE uint32_t LL_TIM_GetPrescaler(TIM_TypeDef *TIMx)
{
  return (uint32_t)(READ_REG(TIMx->PSCR));
}
...
/**
  ...
  * @rmtoll PRD          PRD           LL_TIM_SetAutoReload
  * @param  TIMx Timer instance
  * @param  AutoReload between Min_Data=0 and Max_Data=65535
  */
__STATIC_INLINE void LL_TIM_SetAutoReload(TIM_TypeDef *TIMx, uint32_t AutoReload)
{
  WRITE_REG(TIMx->PRD, AutoReload);
}

/**
  * @brief  Get the auto-reload value.
  * @rmtoll PRD          PRD           LL_TIM_GetAutoReload
  * @note Macro IS_TIM_32B_COUNTER_INSTANCE(TIMx) can be used to check
  *       whether or not a timer instance supports a 32 bits counter.
  * @param  TIMx Timer instance
...
{
  return (uint32_t)(READ_REG(TIMx->PRD));
}
...
/**
  ...
  * @rmtoll REP          REP           LL_TIM_SetRepetitionCounter
  * @param  TIMx Timer instance
...
/**
  ...
  * @note Macro IS_TIM_REPETITION_COUNTER_INSTANCE(TIMx) can be used to check
  *       whether or not a timer instance supports a repetition counter.
  * @rmtoll REP          REP           LL_TIM_GetRepetitionCounter
  * @param  TIMx Timer instance
  * @retval Repetition counter value
  */
__STATIC_INLINE uint32_t LL_TIM_GetRepetitionCounter(TIM_TypeDef *TIMx)
{
  return (uint32_t)(READ_REG(TIMx->REP));
}
...
/**
  ...
  *       in an atomic way.
  * @rmtoll CTRL1          UIFREMAP      LL_TIM_EnableUIFRemap
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableUIFRemap(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->CTRL1, TIM_CR1_UIFREMAP);
}

/**
  * @brief  Disable update interrupt flag (UIF) remapping.
  * @rmtoll CTRL1          UIFREMAP      LL_TIM_DisableUIFRemap
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableUIFRemap(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->CTRL1, TIM_CR1_UIFREMAP);
}
...
/**
  ...
  * @rmtoll CTRL2          CCPC          LL_TIM_CC_EnablePreload
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_CC_EnablePreload(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->CTRL2, TIM_CR2_CCPC);
}
...
/**
  ...
  * @note Macro IS_TIM_COMMUTATION_EVENT_INSTANCE(TIMx) can be used to check
  *       whether or not a timer instance is able to generate a commutation event.
  * @rmtoll CTRL2          CCPC          LL_TIM_CC_DisablePreload
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_CC_DisablePreload(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->CTRL2, TIM_CR2_CCPC);
}
...
/**
  ...
  * @note Macro IS_TIM_COMMUTATION_EVENT_INSTANCE(TIMx) can be used to check
  *       whether or not a timer instance is able to generate a commutation event.
  * @rmtoll CTRL2          CCUS          LL_TIM_CC_SetUpdate
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->CTRL2, TIM_CR2_CCUS, CCUpdateSource);
}

/**
  * @brief  Set the trigger of the capture/compare DMA request.
  * @rmtoll CTRL2          CCDS          LL_TIM_CC_SetDMAReqTrigger
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->CTRL2, TIM_CR2_CCDS, DMAReqTrigger);
}

/**
  * @brief  Get actual trigger of the capture/compare DMA request.
  * @rmtoll CTRL2          CCDS          LL_TIM_CC_GetDMAReqTrigger
  * @param  TIMx Timer instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref LL_TIM_CCDMAREQUEST_CC
  *         @arg @ref LL_TIM_CCDMAREQUEST_UPDATE
...
{
  return (uint32_t)(READ_BIT(TIMx->CTRL2, TIM_CR2_CCDS));
}
...
/**
  ...
  * @rmtoll BKDT         LOCK          LL_TIM_CC_SetLockLevel
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->BKDT, TIM_BDTR_LOCK, LockLevel);
}

/**
  * @brief  Enable capture/compare channels.
  * @rmtoll CHEP         CC1E          LL_TIM_CC_EnableChannel\n
  *         CHEP         CC1NE         LL_TIM_CC_EnableChannel\n
  *         CHEP         CC2E          LL_TIM_CC_EnableChannel\n
  *         CHEP         CC2NE         LL_TIM_CC_EnableChannel\n
  *         CHEP         CC3E          LL_TIM_CC_EnableChannel\n
  *         CHEP         CC3NE         LL_TIM_CC_EnableChannel\n
  *         CHEP         CC4E          LL_TIM_CC_EnableChannel\n
  *         CHEP         CC5E          LL_TIM_CC_EnableChannel\n
  *         CHEP         CC6E          LL_TIM_CC_EnableChannel
  * @param  TIMx Timer instance
...
{
  SET_BIT(TIMx->CHEP, Channels);
}

/**
  * @brief  Disable capture/compare channels.
  * @rmtoll CHEP         CC1E          LL_TIM_CC_DisableChannel\n
  *         CHEP         CC1NE         LL_TIM_CC_DisableChannel\n
  *         CHEP         CC2E          LL_TIM_CC_DisableChannel\n
  *         CHEP         CC2NE         LL_TIM_CC_DisableChannel\n
  *         CHEP         CC3E          LL_TIM_CC_DisableChannel\n
  *         CHEP         CC3NE         LL_TIM_CC_DisableChannel\n
  *         CHEP         CC4E          LL_TIM_CC_DisableChannel\n
  *         CHEP         CC5E          LL_TIM_CC_DisableChannel\n
  *         CHEP         CC6E          LL_TIM_CC_DisableChannel
  * @param  TIMx Timer instance
  * @param  Channels This parameter can be a combination of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH1N
...
{
  CLEAR_BIT(TIMx->CHEP, Channels);
}

/**
  * @brief  Indicate whether channel(s) is(are) enabled.
  * @rmtoll CHEP         CC1E          LL_TIM_CC_IsEnabledChannel\n
  *         CHEP         CC1NE         LL_TIM_CC_IsEnabledChannel\n
  *         CHEP         CC2E          LL_TIM_CC_IsEnabledChannel\n
  *         CHEP         CC2NE         LL_TIM_CC_IsEnabledChannel\n
  *         CHEP         CC3E          LL_TIM_CC_IsEnabledChannel\n
  *         CHEP         CC3NE         LL_TIM_CC_IsEnabledChannel\n
  *         CHEP         CC4E          LL_TIM_CC_IsEnabledChannel\n
  *         CHEP         CC5E          LL_TIM_CC_IsEnabledChannel\n
  *         CHEP         CC6E          LL_TIM_CC_IsEnabledChannel
  * @param  TIMx Timer instance
  * @param  Channels This parameter can be a combination of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH1N
...
{
  return ((READ_BIT(TIMx->CHEP, Channels) == (Channels)) ? 1UL : 0UL);
}
...
/**
  ...
  * @rmtoll CHMD1        CC1S          LL_TIM_OC_ConfigOutput\n
  *         CHMD1        CC2S          LL_TIM_OC_ConfigOutput\n
  *         CHMD2        CC3S          LL_TIM_OC_ConfigOutput\n
  *         CHMD2        CC4S          LL_TIM_OC_ConfigOutput\n
  *         CHMD3        CC5S          LL_TIM_OC_ConfigOutput\n
  *         CHMD3        CC6S          LL_TIM_OC_ConfigOutput\n
  *         CHEP         CC1P          LL_TIM_OC_ConfigOutput\n
  *         CHEP         CC2P          LL_TIM_OC_ConfigOutput\n
  *         CHEP         CC3P          LL_TIM_OC_ConfigOutput\n
  *         CHEP         CC4P          LL_TIM_OC_ConfigOutput\n
  *         CHEP         CC5P          LL_TIM_OC_ConfigOutput\n
  *         CHEP         CC6P          LL_TIM_OC_ConfigOutput\n
  *         CTRL2          OIS1          LL_TIM_OC_ConfigOutput\n
  *         CTRL2          OIS2          LL_TIM_OC_ConfigOutput\n
  *         CTRL2          OIS3          LL_TIM_OC_ConfigOutput\n
  *         CTRL2          OIS4          LL_TIM_OC_ConfigOutput\n
  *         CTRL2          OIS5          LL_TIM_OC_ConfigOutput\n
  *         CTRL2          OIS6          LL_TIM_OC_ConfigOutput
  * @param  TIMx Timer instance
...
__STATIC_INLINE void LL_TIM_OC_ConfigOutput(TIM_TypeDef *TIMx, uint32_t Channel, uint32_t Configuration)
{
  ...
  __IO uint32_t *pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&TIMx->CHMD1) + OFFSET_TAB_CCMRx[iChannel]));
  CLEAR_BIT(*pReg, (TIM_CCMR1_CC1S << SHIFT_TAB_OCxx[iChannel]));
  MODIFY_REG(TIMx->CHEP, (TIM_CCER_CC1P << SHIFT_TAB_CCxP[iChannel]),
             (Configuration & TIM_CCER_CC1P) << SHIFT_TAB_CCxP[iChannel]);
  MODIFY_REG(TIMx->CTRL2, (TIM_CR2_OIS1 << SHIFT_TAB_OISx[iChannel]),
...
/**
  ...
  * @rmtoll CHMD1        OC1M          LL_TIM_OC_SetMode\n
  *         CHMD1        OC2M          LL_TIM_OC_SetMode\n
  *         CHMD2        OC3M          LL_TIM_OC_SetMode\n
  *         CHMD2        OC4M          LL_TIM_OC_SetMode\n
  *         CHMD3        OC5M          LL_TIM_OC_SetMode\n
  *         CHMD3        OC6M          LL_TIM_OC_SetMode
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHMD1        OC1M          LL_TIM_OC_GetMode\n
  *         CHMD1        OC2M          LL_TIM_OC_GetMode\n
  *         CHMD2        OC3M          LL_TIM_OC_GetMode\n
  *         CHMD2        OC4M          LL_TIM_OC_GetMode\n
  *         CHMD3        OC5M          LL_TIM_OC_GetMode\n
  *         CHMD3        OC6M          LL_TIM_OC_GetMode
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
{
  uint8_t iChannel = TIM_GET_CHANNEL_INDEX(Channel);
  const __IO uint32_t *pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&TIMx->CHMD1) + OFFSET_TAB_CCMRx[iChannel]));
  return (READ_BIT(*pReg, ((TIM_CCMR1_OC1M | TIM_CCMR1_CC1S) << SHIFT_TAB_OCxx[iChannel])) >> SHIFT_TAB_OCxx[iChannel]);
}

/**
  * @brief  Set the polarity of an output channel.
  * @rmtoll CHEP         CC1P          LL_TIM_OC_SetPolarity\n
  *         CHEP         CC1NP         LL_TIM_OC_SetPolarity\n
  *         CHEP         CC2P          LL_TIM_OC_SetPolarity\n
  *         CHEP         CC2NP         LL_TIM_OC_SetPolarity\n
  *         CHEP         CC3P          LL_TIM_OC_SetPolarity\n
  *         CHEP         CC3NP         LL_TIM_OC_SetPolarity\n
  *         CHEP         CC4P          LL_TIM_OC_SetPolarity\n
  *         CHEP         CC5P          LL_TIM_OC_SetPolarity\n
  *         CHEP         CC6P          LL_TIM_OC_SetPolarity
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH1N
...
{
  uint8_t iChannel = TIM_GET_CHANNEL_INDEX(Channel);
  MODIFY_REG(TIMx->CHEP, (TIM_CCER_CC1P << SHIFT_TAB_CCxP[iChannel]),  Polarity << SHIFT_TAB_CCxP[iChannel]);
}

/**
  * @brief  Get the polarity of an output channel.
  * @rmtoll CHEP         CC1P          LL_TIM_OC_GetPolarity\n
  *         CHEP         CC1NP         LL_TIM_OC_GetPolarity\n
  *         CHEP         CC2P          LL_TIM_OC_GetPolarity\n
  *         CHEP         CC2NP         LL_TIM_OC_GetPolarity\n
  *         CHEP         CC3P          LL_TIM_OC_GetPolarity\n
  *         CHEP         CC3NP         LL_TIM_OC_GetPolarity\n
  *         CHEP         CC4P          LL_TIM_OC_GetPolarity\n
  *         CHEP         CC5P          LL_TIM_OC_GetPolarity\n
  *         CHEP         CC6P          LL_TIM_OC_GetPolarity
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH1N
...
{
  uint8_t iChannel = TIM_GET_CHANNEL_INDEX(Channel);
  return (READ_BIT(TIMx->CHEP, (TIM_CCER_CC1P << SHIFT_TAB_CCxP[iChannel])) >> SHIFT_TAB_CCxP[iChannel]);
}
...
/**
  ...
  *       a break input.
  * @rmtoll CTRL2         OIS1          LL_TIM_OC_SetIdleState\n
  *         CTRL2         OIS2N         LL_TIM_OC_SetIdleState\n
  *         CTRL2         OIS2          LL_TIM_OC_SetIdleState\n
  *         CTRL2         OIS2N         LL_TIM_OC_SetIdleState\n
  *         CTRL2         OIS3          LL_TIM_OC_SetIdleState\n
  *         CTRL2         OIS3N         LL_TIM_OC_SetIdleState\n
  *         CTRL2         OIS4          LL_TIM_OC_SetIdleState\n
  *         CTRL2         OIS5          LL_TIM_OC_SetIdleState\n
  *         CTRL2         OIS6          LL_TIM_OC_SetIdleState
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH1N
...
{
  uint8_t iChannel = TIM_GET_CHANNEL_INDEX(Channel);
  MODIFY_REG(TIMx->CTRL2, (TIM_CR2_OIS1 << SHIFT_TAB_OISx[iChannel]),  IdleState << SHIFT_TAB_OISx[iChannel]);
}

/**
  * @brief  Get the IDLE state of an output channel
  * @rmtoll CTRL2         OIS1          LL_TIM_OC_GetIdleState\n
  *         CTRL2         OIS2N         LL_TIM_OC_GetIdleState\n
  *         CTRL2         OIS2          LL_TIM_OC_GetIdleState\n
  *         CTRL2         OIS2N         LL_TIM_OC_GetIdleState\n
  *         CTRL2         OIS3          LL_TIM_OC_GetIdleState\n
  *         CTRL2         OIS3N         LL_TIM_OC_GetIdleState\n
  *         CTRL2         OIS4          LL_TIM_OC_GetIdleState\n
  *         CTRL2         OIS5          LL_TIM_OC_GetIdleState\n
  *         CTRL2         OIS6          LL_TIM_OC_GetIdleState
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH1N
...
{
  uint8_t iChannel = TIM_GET_CHANNEL_INDEX(Channel);
  return (READ_BIT(TIMx->CTRL2, (TIM_CR2_OIS1 << SHIFT_TAB_OISx[iChannel])) >> SHIFT_TAB_OISx[iChannel]);
}

/**
  * @brief  Enable fast mode for the output channel.
  * @note Acts only if the channel is configured in PWM1 or PWM2 mode.
  * @rmtoll CHMD1        OC1FE          LL_TIM_OC_EnableFast\n
  *         CHMD1        OC2FE          LL_TIM_OC_EnableFast\n
  *         CHMD2        OC3FE          LL_TIM_OC_EnableFast\n
  *         CHMD2        OC4FE          LL_TIM_OC_EnableFast\n
  *         CHMD3        OC5FE          LL_TIM_OC_EnableFast\n
  *         CHMD3        OC6FE          LL_TIM_OC_EnableFast
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHMD1        OC1FE          LL_TIM_OC_DisableFast\n
  *         CHMD1        OC2FE          LL_TIM_OC_DisableFast\n
  *         CHMD2        OC3FE          LL_TIM_OC_DisableFast\n
  *         CHMD2        OC4FE          LL_TIM_OC_DisableFast\n
  *         CHMD3        OC5FE          LL_TIM_OC_DisableFast\n
  *         CHMD3        OC6FE          LL_TIM_OC_DisableFast
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHMD1        OC1FE          LL_TIM_OC_IsEnabledFast\n
  *         CHMD1        OC2FE          LL_TIM_OC_IsEnabledFast\n
  *         CHMD2        OC3FE          LL_TIM_OC_IsEnabledFast\n
  *         CHMD2        OC4FE          LL_TIM_OC_IsEnabledFast\n
  *         CHMD3        OC5FE          LL_TIM_OC_IsEnabledFast\n
  *         CHMD3        OC6FE          LL_TIM_OC_IsEnabledFast
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHMD1        OC1PE          LL_TIM_OC_EnablePreload\n
  *         CHMD1        OC2PE          LL_TIM_OC_EnablePreload\n
  *         CHMD2        OC3PE          LL_TIM_OC_EnablePreload\n
  *         CHMD2        OC4PE          LL_TIM_OC_EnablePreload\n
  *         CHMD3        OC5PE          LL_TIM_OC_EnablePreload\n
  *         CHMD3        OC6PE          LL_TIM_OC_EnablePreload
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHMD1        OC1PE          LL_TIM_OC_DisablePreload\n
  *         CHMD1        OC2PE          LL_TIM_OC_DisablePreload\n
  *         CHMD2        OC3PE          LL_TIM_OC_DisablePreload\n
  *         CHMD2        OC4PE          LL_TIM_OC_DisablePreload\n
  *         CHMD3        OC5PE          LL_TIM_OC_DisablePreload\n
  *         CHMD3        OC6PE          LL_TIM_OC_DisablePreload
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHMD1        OC1PE          LL_TIM_OC_IsEnabledPreload\n
  *         CHMD1        OC2PE          LL_TIM_OC_IsEnabledPreload\n
  *         CHMD2        OC3PE          LL_TIM_OC_IsEnabledPreload\n
  *         CHMD2        OC4PE          LL_TIM_OC_IsEnabledPreload\n
  *         CHMD3        OC5PE          LL_TIM_OC_IsEnabledPreload\n
  *         CHMD3        OC6PE          LL_TIM_OC_IsEnabledPreload
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHMD1        OC1CE          LL_TIM_OC_EnableClear\n
  *         CHMD1        OC2CE          LL_TIM_OC_EnableClear\n
  *         CHMD2        OC3CE          LL_TIM_OC_EnableClear\n
  *         CHMD2        OC4CE          LL_TIM_OC_EnableClear\n
  *         CHMD3        OC5CE          LL_TIM_OC_EnableClear\n
  *         CHMD3        OC6CE          LL_TIM_OC_EnableClear
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @note Macro IS_TIM_OCXREF_CLEAR_INSTANCE(TIMx) can be used to check whether
  *       or not a timer instance can clear the OCxREF signal on an external event.
  * @rmtoll CHMD1        OC1CE          LL_TIM_OC_DisableClear\n
  *         CHMD1        OC2CE          LL_TIM_OC_DisableClear\n
  *         CHMD2        OC3CE          LL_TIM_OC_DisableClear\n
  *         CHMD2        OC4CE          LL_TIM_OC_DisableClear\n
  *         CHMD3        OC5CE          LL_TIM_OC_DisableClear\n
  *         CHMD3        OC6CE          LL_TIM_OC_DisableClear
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @note Macro IS_TIM_OCXREF_CLEAR_INSTANCE(TIMx) can be used to check whether
  *       or not a timer instance can clear the OCxREF signal on an external event.
  * @rmtoll CHMD1        OC1CE          LL_TIM_OC_IsEnabledClear\n
  *         CHMD1        OC2CE          LL_TIM_OC_IsEnabledClear\n
  *         CHMD2        OC3CE          LL_TIM_OC_IsEnabledClear\n
  *         CHMD2        OC4CE          LL_TIM_OC_IsEnabledClear\n
  *         CHMD3        OC5CE          LL_TIM_OC_IsEnabledClear\n
  *         CHMD3        OC6CE          LL_TIM_OC_IsEnabledClear
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll DTR1         DTG1P           LL_TIM_OC_SetDeadTime\n
  * @rmtoll DTR1         DTG1N           LL_TIM_OC_SetDeadTime\n
  * @rmtoll DTR1         DTG2P           LL_TIM_OC_SetDeadTime\n
  * @rmtoll DTR1         DTG2N           LL_TIM_OC_SetDeadTime\n
  * @rmtoll DTR2         DTG3P           LL_TIM_OC_SetDeadTime\n
  * @rmtoll DTR2         DTG3N           LL_TIM_OC_SetDeadTime
  * @param  TIMx Timer instance
  * @param  DeadTime between Min_Data=0 and Max_Data=255
  */
__STATIC_INLINE void LL_TIM_OC_SetDeadTime(TIM_TypeDef *TIMx, uint32_t DeadTime)
{
//  MODIFY_REG(TIMx->BKDT, TIM_BDTR_DTG, DeadTime);
  MODIFY_REG(TIMx->DTR1, TIM_DTR_DTG1P | TIM_DTR_DTG1N, (DeadTime << TIM_DTR_DTG1P_Pos) | (DeadTime << TIM_DTR_DTG1N_Pos));
  MODIFY_REG(TIMx->DTR1, TIM_DTR_DTG2P | TIM_DTR_DTG2N, (DeadTime << TIM_DTR_DTG2P_Pos) | (DeadTime << TIM_DTR_DTG2N_Pos));
  MODIFY_REG(TIMx->DTR2, TIM_DTR_DTG3P | TIM_DTR_DTG3N, (DeadTime << TIM_DTR_DTG3P_Pos) | (DeadTime << TIM_DTR_DTG3N_Pos));
}

/**
  * @brief  Set the dead-time delay (delay inserted between the rising edge of the OCxREF signal and the rising edge of
  *         the Ocx and OCxN signals) for output channel 1.
  * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
  *       dead-time insertion feature is supported by a timer instance.
  * @note Helper macro @ref __LL_TIM_CALC_DEADTIME can be used to calculate the DeadTime parameter
  * @rmtoll DTR1         DTG1P           LL_TIM_OC_SetDeadTimeCH1\n
  * @rmtoll DTR1         DTG1N           LL_TIM_OC_SetDeadTimeCH1
  * @param  TIMx Timer instance
  * @param  DeadTime between Min_Data=0 and Max_Data=255
  * @param  NDeadTime between Min_Data=0 and Max_Data=255
  */
__STATIC_INLINE void LL_TIM_OC_SetDeadTimeCH1(TIM_TypeDef *TIMx, uint32_t DeadTime, uint32_t NDeadTime)
{
  MODIFY_REG(TIMx->DTR1, TIM_DTR_DTG1P | TIM_DTR_DTG1N, (DeadTime << TIM_DTR_DTG1P_Pos) | (NDeadTime << TIM_DTR_DTG1N_Pos));
}

/**
  * @brief  Set the dead-time delay (delay inserted between the rising edge of the OCxREF signal and the rising edge of
  *         the Ocx and OCxN signals) for output channel 2.
  * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
  *       dead-time insertion feature is supported by a timer instance.
  * @note Helper macro @ref __LL_TIM_CALC_DEADTIME can be used to calculate the DeadTime parameter
  * @rmtoll DTR1         DTG2P           LL_TIM_OC_SetDeadTimeCH2\n
  * @rmtoll DTR1         DTG2N           LL_TIM_OC_SetDeadTimeCH2
  * @param  TIMx Timer instance
  * @param  DeadTime between Min_Data=0 and Max_Data=255
  * @param  NDeadTime between Min_Data=0 and Max_Data=255
  */
__STATIC_INLINE void LL_TIM_OC_SetDeadTimeCH2(TIM_TypeDef *TIMx, uint32_t DeadTime, uint32_t NDeadTime)
{
  MODIFY_REG(TIMx->DTR1, TIM_DTR_DTG2P | TIM_DTR_DTG2N, (DeadTime << TIM_DTR_DTG2P_Pos) | (NDeadTime << TIM_DTR_DTG2N_Pos));
}

/**
  * @brief  Set the dead-time delay (delay inserted between the rising edge of the OCxREF signal and the rising edge of
  *         the Ocx and OCxN signals) for output channel 3.
  * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
  *       dead-time insertion feature is supported by a timer instance.
  * @note Helper macro @ref __LL_TIM_CALC_DEADTIME can be used to calculate the DeadTime parameter
  * @rmtoll DTR2         DTG3P           LL_TIM_OC_SetDeadTimeCH3\n
  * @rmtoll DTR2         DTG3N           LL_TIM_OC_SetDeadTimeCH3
  * @param  TIMx Timer instance
  * @param  DeadTime between Min_Data=0 and Max_Data=255
  * @param  NDeadTime between Min_Data=0 and Max_Data=255
  */
__STATIC_INLINE void LL_TIM_OC_SetDeadTimeCH3(TIM_TypeDef *TIMx, uint32_t DeadTime, uint32_t NDeadTime)
{
  MODIFY_REG(TIMx->DTR2, TIM_DTR_DTG3P | TIM_DTR_DTG3N, (DeadTime << TIM_DTR_DTG3P_Pos) | (NDeadTime << TIM_DTR_DTG3N_Pos));
}
...
/**
  ...
  * @rmtoll CHR1         CHR1          LL_TIM_OC_SetCompareCH1
  * @param  TIMx Timer instance
  * @param  CompareValue between Min_Data=0 and Max_Data=65535
  */
__STATIC_INLINE void LL_TIM_OC_SetCompareCH1(TIM_TypeDef *TIMx, uint32_t CompareValue)
{
  WRITE_REG(TIMx->CHR1, CompareValue);
}
...
/**
  ...
  * @rmtoll CHR2         CHR2          LL_TIM_OC_SetCompareCH2
  * @param  TIMx Timer instance
  * @param  CompareValue between Min_Data=0 and Max_Data=65535
  */
__STATIC_INLINE void LL_TIM_OC_SetCompareCH2(TIM_TypeDef *TIMx, uint32_t CompareValue)
{
  WRITE_REG(TIMx->CHR2, CompareValue);
}
...
/**
  ...
  * @rmtoll CHR3         CHR3          LL_TIM_OC_SetCompareCH3
  * @param  TIMx Timer instance
  * @param  CompareValue between Min_Data=0 and Max_Data=65535
  */
__STATIC_INLINE void LL_TIM_OC_SetCompareCH3(TIM_TypeDef *TIMx, uint32_t CompareValue)
{
  WRITE_REG(TIMx->CHR3, CompareValue);
}
...
/**
  ...
  * @rmtoll CHR4         CHR4          LL_TIM_OC_SetCompareCH4
  * @param  TIMx Timer instance
  * @param  CompareValue between Min_Data=0 and Max_Data=65535
  */
__STATIC_INLINE void LL_TIM_OC_SetCompareCH4(TIM_TypeDef *TIMx, uint32_t CompareValue)
{
  WRITE_REG(TIMx->CHR4, CompareValue);
}
...
/**
  ...
  * @rmtoll CHR5         CHR5          LL_TIM_OC_SetCompareCH5
  * @param  TIMx Timer instance
  * @param  CompareValue between Min_Data=0 and Max_Data=65535
  */
__STATIC_INLINE void LL_TIM_OC_SetCompareCH5(TIM_TypeDef *TIMx, uint32_t CompareValue)
{
  MODIFY_REG(TIMx->CHR5, TIM_CCR5_CCR5, CompareValue);
}
...
/**
  ...
  * @rmtoll CHR6         CHR6          LL_TIM_OC_SetCompareCH6
  * @param  TIMx Timer instance
  * @param  CompareValue between Min_Data=0 and Max_Data=65535
  */
__STATIC_INLINE void LL_TIM_OC_SetCompareCH6(TIM_TypeDef *TIMx, uint32_t CompareValue)
{
  WRITE_REG(TIMx->CHR6, CompareValue);
}
...
/**
  ...
  * @note Macro IS_TIM_CC1_INSTANCE(TIMx) can be used to check whether or not
  *       output channel 1 is supported by a timer instance.
  * @rmtoll CHR1         CHR1          LL_TIM_OC_GetCompareCH1
  * @param  TIMx Timer instance
  * @retval CompareValue (between Min_Data=0 and Max_Data=65535)
  */
__STATIC_INLINE uint32_t LL_TIM_OC_GetCompareCH1(TIM_TypeDef *TIMx)
{
  return (uint32_t)(READ_REG(TIMx->CHR1));
}
...
/**
  ...
  * @note Macro IS_TIM_CC2_INSTANCE(TIMx) can be used to check whether or not
  *       output channel 2 is supported by a timer instance.
  * @rmtoll CHR2         CHR2          LL_TIM_OC_GetCompareCH2
  * @param  TIMx Timer instance
  * @retval CompareValue (between Min_Data=0 and Max_Data=65535)
  */
__STATIC_INLINE uint32_t LL_TIM_OC_GetCompareCH2(TIM_TypeDef *TIMx)
{
  return (uint32_t)(READ_REG(TIMx->CHR2));
}
...
/**
  ...
  * @rmtoll CHR3         CHR3          LL_TIM_OC_GetCompareCH3
  * @param  TIMx Timer instance
  * @retval CompareValue (between Min_Data=0 and Max_Data=65535)
  */
__STATIC_INLINE uint32_t LL_TIM_OC_GetCompareCH3(TIM_TypeDef *TIMx)
{
  return (uint32_t)(READ_REG(TIMx->CHR3));
}
...
/**
  ...
  * @note Macro IS_TIM_CC4_INSTANCE(TIMx) can be used to check whether or not
  *       output channel 4 is supported by a timer instance.
  * @rmtoll CHR4         CHR4          LL_TIM_OC_GetCompareCH4
  * @param  TIMx Timer instance
  * @retval CompareValue (between Min_Data=0 and Max_Data=65535)
  */
__STATIC_INLINE uint32_t LL_TIM_OC_GetCompareCH4(TIM_TypeDef *TIMx)
{
  return (uint32_t)(READ_REG(TIMx->CHR4));
}
...
/**
  ...
  * @note Macro IS_TIM_CC5_INSTANCE(TIMx) can be used to check whether or not
  *       output channel 5 is supported by a timer instance.
  * @rmtoll CHR5         CHR5          LL_TIM_OC_GetCompareCH5
  * @param  TIMx Timer instance
  * @retval CompareValue (between Min_Data=0 and Max_Data=65535)
  */
__STATIC_INLINE uint32_t LL_TIM_OC_GetCompareCH5(TIM_TypeDef *TIMx)
{
  return (uint32_t)(READ_BIT(TIMx->CHR5, TIM_CCR5_CCR5));
}
...
/**
  ...
  * @note Macro IS_TIM_CC6_INSTANCE(TIMx) can be used to check whether or not
  *       output channel 6 is supported by a timer instance.
  * @rmtoll CHR6         CHR6          LL_TIM_OC_GetCompareCH6
  * @param  TIMx Timer instance
  * @retval CompareValue (between Min_Data=0 and Max_Data=65535)
  */
__STATIC_INLINE uint32_t LL_TIM_OC_GetCompareCH6(TIM_TypeDef *TIMx)
{
  return (uint32_t)(READ_REG(TIMx->CHR6));
}
...
/**
  ...
  * @rmtoll CHR5         GC5C3          LL_TIM_SetCH5CombinedChannels\n
  *         CHR5         GC5C2          LL_TIM_SetCH5CombinedChannels\n
  *         CHR5         GC5C1          LL_TIM_SetCH5CombinedChannels
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->CHR5, (TIM_CCR5_GC5C3 | TIM_CCR5_GC5C2 | TIM_CCR5_GC5C1), GroupCH5);
}
...
/**
  ...
  * @rmtoll CHMD1        CC1S          LL_TIM_IC_Config\n
  *         CHMD1        IC1PSC        LL_TIM_IC_Config\n
  *         CHMD1        IC1F          LL_TIM_IC_Config\n
  *         CHMD1        CC2S          LL_TIM_IC_Config\n
  *         CHMD1        IC2PSC        LL_TIM_IC_Config\n
  *         CHMD1        IC2F          LL_TIM_IC_Config\n
  *         CHMD2        CC3S          LL_TIM_IC_Config\n
  *         CHMD2        IC3PSC        LL_TIM_IC_Config\n
  *         CHMD2        IC3F          LL_TIM_IC_Config\n
  *         CHMD2        CC4S          LL_TIM_IC_Config\n
  *         CHMD2        IC4PSC        LL_TIM_IC_Config\n
  *         CHMD2        IC4F          LL_TIM_IC_Config\n
  *         CHEP         CC1P          LL_TIM_IC_Config\n
  *         CHEP         CC1NP         LL_TIM_IC_Config\n
  *         CHEP         CC2P          LL_TIM_IC_Config\n
  *         CHEP         CC2NP         LL_TIM_IC_Config\n
  *         CHEP         CC3P          LL_TIM_IC_Config\n
  *         CHEP         CC3NP         LL_TIM_IC_Config\n
  *         CHEP         CC4P          LL_TIM_IC_Config\n
  *         CHEP         CC4NP         LL_TIM_IC_Config
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
__STATIC_INLINE void LL_TIM_IC_Config(TIM_TypeDef *TIMx, uint32_t Channel, uint32_t Configuration)
{
  ...
  MODIFY_REG(TIMx->CHEP, ((TIM_CCER_CC1NP | TIM_CCER_CC1P) << SHIFT_TAB_CCxP[iChannel]),
             (Configuration & (TIM_CCER_CC1NP | TIM_CCER_CC1P)) << SHIFT_TAB_CCxP[iChannel]);
}

/**
  * @brief  Set the active input.
  * @rmtoll CHMD1        CC1S          LL_TIM_IC_SetActiveInput\n
  *         CHMD1        CC2S          LL_TIM_IC_SetActiveInput\n
  *         CHMD2        CC3S          LL_TIM_IC_SetActiveInput\n
  *         CHMD2        CC4S          LL_TIM_IC_SetActiveInput
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHMD1        CC1S          LL_TIM_IC_GetActiveInput\n
  *         CHMD1        CC2S          LL_TIM_IC_GetActiveInput\n
  *         CHMD2        CC3S          LL_TIM_IC_GetActiveInput\n
  *         CHMD2        CC4S          LL_TIM_IC_GetActiveInput
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHMD1        IC1PSC        LL_TIM_IC_SetPrescaler\n
  *         CHMD1        IC2PSC        LL_TIM_IC_SetPrescaler\n
  *         CHMD2        IC3PSC        LL_TIM_IC_SetPrescaler\n
  *         CHMD2        IC4PSC        LL_TIM_IC_SetPrescaler
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHMD1        IC1PSC        LL_TIM_IC_GetPrescaler\n
  *         CHMD1        IC2PSC        LL_TIM_IC_GetPrescaler\n
  *         CHMD2        IC3PSC        LL_TIM_IC_GetPrescaler\n
  *         CHMD2        IC4PSC        LL_TIM_IC_GetPrescaler
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHMD1        IC1F          LL_TIM_IC_SetFilter\n
  *         CHMD1        IC2F          LL_TIM_IC_SetFilter\n
  *         CHMD2        IC3F          LL_TIM_IC_SetFilter\n
  *         CHMD2        IC4F          LL_TIM_IC_SetFilter
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHMD1        IC1F          LL_TIM_IC_GetFilter\n
  *         CHMD1        IC2F          LL_TIM_IC_GetFilter\n
  *         CHMD2        IC3F          LL_TIM_IC_GetFilter\n
  *         CHMD2        IC4F          LL_TIM_IC_GetFilter
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHEP         CC1P          LL_TIM_IC_SetPolarity\n
  *         CHEP         CC1NP         LL_TIM_IC_SetPolarity\n
  *         CHEP         CC2P          LL_TIM_IC_SetPolarity\n
  *         CHEP         CC2NP         LL_TIM_IC_SetPolarity\n
  *         CHEP         CC3P          LL_TIM_IC_SetPolarity\n
  *         CHEP         CC3NP         LL_TIM_IC_SetPolarity\n
  *         CHEP         CC4P          LL_TIM_IC_SetPolarity\n
  *         CHEP         CC4NP         LL_TIM_IC_SetPolarity
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
/**
  ...
  * @rmtoll CHEP         CC1P          LL_TIM_IC_GetPolarity\n
  *         CHEP         CC1NP         LL_TIM_IC_GetPolarity\n
  *         CHEP         CC2P          LL_TIM_IC_GetPolarity\n
  *         CHEP         CC2NP         LL_TIM_IC_GetPolarity\n
  *         CHEP         CC3P          LL_TIM_IC_GetPolarity\n
  *         CHEP         CC3NP         LL_TIM_IC_GetPolarity\n
  *         CHEP         CC4P          LL_TIM_IC_GetPolarity\n
  *         CHEP         CC4NP         LL_TIM_IC_GetPolarity
  * @param  TIMx Timer instance
  * @param  Channel This parameter can be one of the following values:
  *         @arg @ref LL_TIM_CHANNEL_CH1
  *         @arg @ref LL_TIM_CHANNEL_CH2
...
{
  uint8_t iChannel = TIM_GET_CHANNEL_INDEX(Channel);
  return (READ_BIT(TIMx->CHEP, ((TIM_CCER_CC1NP | TIM_CCER_CC1P) << SHIFT_TAB_CCxP[iChannel])) >>
...
/**
  ...
  * @rmtoll CTRL2          TI1S          LL_TIM_IC_EnableXORCombination
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_IC_EnableXORCombination(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->CTRL2, TIM_CR2_TI1S);
}
...
/**
  ...
  * @note Macro IS_TIM_XOR_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance provides an XOR input.
  * @rmtoll CTRL2          TI1S          LL_TIM_IC_DisableXORCombination
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_IC_DisableXORCombination(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->CTRL2, TIM_CR2_TI1S);
}
...
/**
  ...
  * @note Macro IS_TIM_XOR_INSTANCE(TIMx) can be used to check whether or not
  * a timer instance provides an XOR input.
  * @rmtoll CTRL2          TI1S          LL_TIM_IC_IsEnabledXORCombination
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IC_IsEnabledXORCombination(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->CTRL2, TIM_CR2_TI1S) == (TIM_CR2_TI1S)) ? 1UL : 0UL);
}
...
/**
  ...
  * @rmtoll CHR1         CHR1          LL_TIM_IC_GetCaptureCH1
  * @param  TIMx Timer instance
...
/**
  ...
  * @rmtoll CHR2         CHR2          LL_TIM_IC_GetCaptureCH2
  * @param  TIMx Timer instance
  * @retval CapturedValue (between Min_Data=0 and Max_Data=65535)
  */
...
/**
  ...
  * @rmtoll CHR3         CHR3          LL_TIM_IC_GetCaptureCH3
  * @param  TIMx Timer instance
  * @retval CapturedValue (between Min_Data=0 and Max_Data=65535)
  */
...
/**
  ...
  * @rmtoll CHR4         CHR4          LL_TIM_IC_GetCaptureCH4
  * @param  TIMx Timer instance
  * @retval CapturedValue (between Min_Data=0 and Max_Data=65535)
  */
...
/**
  ...
  * @rmtoll SLVMD         ECE           LL_TIM_EnableExternalClock
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableExternalClock(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->SLVMD, TIM_SMCR_ECE);
}
...
/**
  ...
  * @note Macro IS_TIM_CLOCKSOURCE_ETRMODE2_INSTANCE(TIMx) can be used to check
  *       whether or not a timer instance supports external clock mode2.
  * @rmtoll SLVMD         ECE           LL_TIM_DisableExternalClock
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableExternalClock(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->SLVMD, TIM_SMCR_ECE);
}
...
/**
  ...
  * @note Macro IS_TIM_CLOCKSOURCE_ETRMODE2_INSTANCE(TIMx) can be used to check
  *       whether or not a timer instance supports external clock mode2.
  * @rmtoll SLVMD         ECE           LL_TIM_IsEnabledExternalClock
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledExternalClock(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->SLVMD, TIM_SMCR_ECE) == (TIM_SMCR_ECE)) ? 1UL : 0UL);
}
...
/**
  ...
  * @note Macro IS_TIM_CLOCKSOURCE_ETRMODE2_INSTANCE(TIMx) can be used to check
  *       whether or not a timer instance supports external clock mode2.
  * @rmtoll SLVMD         SMS           LL_TIM_SetClockSource\n
  *         SLVMD         ECE           LL_TIM_SetClockSource
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->SLVMD, TIM_SMCR_SMS | TIM_SMCR_ECE, ClockSource);
}
...
/**
  ...
  * @rmtoll SLVMD         SMS           LL_TIM_SetEncoderMode
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->SLVMD, TIM_SMCR_SMS, EncoderMode);
}
...
/**
  ...
  * @rmtoll CTRL2          MMS           LL_TIM_SetTriggerOutput
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->CTRL2, TIM_CR2_MMS, TimerSynchronization);
}
...
/**
  ...
  * @rmtoll CTRL2          MMS2          LL_TIM_SetTriggerOutput2
  * @param  TIMx Timer Instance
...
{
  MODIFY_REG(TIMx->CTRL2, TIM_CR2_MMS2, ADCSynchronization);
}
...
/**
  ...
  * @rmtoll SLVMD         SMS           LL_TIM_SetSlaveMode
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->SLVMD, TIM_SMCR_SMS, SlaveMode);
}
...
/**
  ...
  * @note Macro IS_TIM_SLAVE_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance can operate as a slave timer.
  * @rmtoll SLVMD         TS            LL_TIM_SetTriggerInput
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->SLVMD, TIM_SMCR_TS, TriggerInput);
}
...
/**
  ...
  * @note Macro IS_TIM_SLAVE_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance can operate as a slave timer.
  * @rmtoll SLVMD         MSM           LL_TIM_EnableMasterSlaveMode
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableMasterSlaveMode(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->SLVMD, TIM_SMCR_MSM);
}
...
/**
  ...
  * @note Macro IS_TIM_SLAVE_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance can operate as a slave timer.
  * @rmtoll SLVMD         MSM           LL_TIM_DisableMasterSlaveMode
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableMasterSlaveMode(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->SLVMD, TIM_SMCR_MSM);
}
...
/**
  ...
  * @note Macro IS_TIM_SLAVE_INSTANCE(TIMx) can be used to check whether or not
  * a timer instance can operate as a slave timer.
  * @rmtoll SLVMD         MSM           LL_TIM_IsEnabledMasterSlaveMode
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledMasterSlaveMode(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->SLVMD, TIM_SMCR_MSM) == (TIM_SMCR_MSM)) ? 1UL : 0UL);
}
...
/**
  ...
  * @rmtoll SLVMD         ETP           LL_TIM_ConfigETR\n
  *         SLVMD         ETPS          LL_TIM_ConfigETR\n
  *         SLVMD         ETF           LL_TIM_ConfigETR
  * @param  TIMx Timer instance
...
__STATIC_INLINE void LL_TIM_ConfigETR(TIM_TypeDef *TIMx, uint32_t ETRPolarity, uint32_t ETRPrescaler,
                                      uint32_t ETRFilter)
{
  MODIFY_REG(TIMx->SLVMD, TIM_SMCR_ETP | TIM_SMCR_ETPS | TIM_SMCR_ETF, ETRPolarity | ETRPrescaler | ETRFilter);
}
...
/**
  ...
  * @rmtoll BRK          ETRSEL        LL_TIM_SetETRSource
  * @param  TIMx Timer instance
...
__STATIC_INLINE void LL_TIM_SetETRSource(TIM_TypeDef *TIMx, uint32_t ETRSource)
{
  ...
  {
    MODIFY_REG(TIMx->BRK, TIMx_AF1_ETRSEL, ETRSource);
  }
  else
  {
    MODIFY_REG(TIMx->BRK, TIMx_AF1_ETRSEL, ETRSource >> etrsel_shift);
  }
#else
  MODIFY_REG(TIMx->BRK, TIMx_AF1_ETRSEL, ETRSource);
#endif /* COMP3 */
...
/**
  ...
  * @rmtoll BKDT         BKE           LL_TIM_EnableBRK
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableBRK(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->BKDT, TIM_BDTR_BKE);
}

/**
  * @brief  Disable the break function.
  * @rmtoll BKDT         BKE           LL_TIM_DisableBRK
  * @param  TIMx Timer instance
  * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance provides a break input.
  */
...
{
  CLEAR_BIT(TIMx->BKDT, TIM_BDTR_BKE);
}
...
/**
  ...
  * @rmtoll BKDT         BKP           LL_TIM_ConfigBRK\n
  *         BKDT         BKF           LL_TIM_ConfigBRK\n
  *         BKDT         BKBID         LL_TIM_ConfigBRK
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->BKDT, TIM_BDTR_BKP | TIM_BDTR_BKF | TIM_BDTR_BKBID, BreakPolarity | BreakFilter | BreakAFMode);
}
...
/**
  ...
  * @rmtoll BKDT         BKDSRM        LL_TIM_DisarmBRK
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisarmBRK(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->BKDT, TIM_BDTR_BKDSRM);
}
...
/**
  ...
  * @rmtoll BKDT         BKDSRM        LL_TIM_ReArmBRK
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ReArmBRK(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->BKDT, TIM_BDTR_BKDSRM);
}
...
/**
  ...
  * @rmtoll BKDT         BK2E          LL_TIM_EnableBRK2
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableBRK2(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->BKDT, TIM_BDTR_BK2E);
}
...
/**
  ...
  * @note Macro IS_TIM_BKIN2_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance provides a second break input.
  * @rmtoll BKDT         BK2E          LL_TIM_DisableBRK2
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableBRK2(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->BKDT, TIM_BDTR_BK2E);
}
...
/**
  ...
  * @rmtoll BKDT         BK2P          LL_TIM_ConfigBRK2\n
  *         BKDT         BK2F          LL_TIM_ConfigBRK2\n
  *         BKDT         BK2BID        LL_TIM_ConfigBRK2
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->BKDT, TIM_BDTR_BK2P | TIM_BDTR_BK2F | TIM_BDTR_BK2BID, Break2Polarity | Break2Filter | Break2AFMode);
}
...
/**
  ...
  * @note  Purpose is to be able to have the input voltage back to high-state,
  *        whatever the time constant on the output.
  * @rmtoll BKDT         BK2DSRM       LL_TIM_DisarmBRK2
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisarmBRK2(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->BKDT, TIM_BDTR_BK2DSRM);
}
...
/**
  ...
  * @rmtoll BKDT         BK2DSRM       LL_TIM_ReArmBRK2
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ReArmBRK2(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->BKDT, TIM_BDTR_BK2DSRM);
}
...
/**
  ...
  * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance provides a break input.
  * @rmtoll BKDT         OSSI          LL_TIM_SetOffStates\n
  *         BKDT         OSSR          LL_TIM_SetOffStates
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->BKDT, TIM_BDTR_OSSI | TIM_BDTR_OSSR, OffStateIdle | OffStateRun);
}
...
/**
  ...
  * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance provides a break input.
  * @rmtoll BKDT         AOE           LL_TIM_EnableAutomaticOutput
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableAutomaticOutput(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->BKDT, TIM_BDTR_AOE);
}
...
/**
  ...
  * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance provides a break input.
  * @rmtoll BKDT         AOE           LL_TIM_DisableAutomaticOutput
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableAutomaticOutput(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->BKDT, TIM_BDTR_AOE);
}
...
/**
  ...
  * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance provides a break input.
  * @rmtoll BKDT         AOE           LL_TIM_IsEnabledAutomaticOutput
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledAutomaticOutput(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->BKDT, TIM_BDTR_AOE) == (TIM_BDTR_AOE)) ? 1UL : 0UL);
}
...
/**
  ...
  * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance provides a break input.
  * @rmtoll BKDT         MOE           LL_TIM_EnableAllOutputs
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableAllOutputs(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->BKDT, TIM_BDTR_MOE);
}
...
/**
  ...
  * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance provides a break input.
  * @rmtoll BKDT         MOE           LL_TIM_DisableAllOutputs
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableAllOutputs(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->BKDT, TIM_BDTR_MOE);
}
...
/**
  ...
  * @note Macro IS_TIM_BREAK_INSTANCE(TIMx) can be used to check whether or not
  *       a timer instance provides a break input.
  * @rmtoll BKDT         MOE           LL_TIM_IsEnabledAllOutputs
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledAllOutputs(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->BKDT, TIM_BDTR_MOE) == (TIM_BDTR_MOE)) ? 1UL : 0UL);
}
...
/**
  ...
  * @rmtoll BRK          BKINE         LL_TIM_EnableBreakInputSource\n
  *         BRK          BKCMP1E       LL_TIM_EnableBreakInputSource\n
  *         BRK          BKCMP2E       LL_TIM_EnableBreakInputSource\n
  *         BRK          BKCMP3E       LL_TIM_EnableBreakInputSource\n
  *         BRK2          BK2INE        LL_TIM_EnableBreakInputSource\n
  *         BRK2          BK2CMP1E      LL_TIM_EnableBreakInputSource\n
  *         BRK2          BK2CMP2E      LL_TIM_EnableBreakInputSource\n
  *         BRK2          BK2CMP3E      LL_TIM_EnableBreakInputSource
  * @param  TIMx Timer instance
...
{
  __IO uint32_t *pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&TIMx->BRK) + BreakInput));
  SET_BIT(*pReg, Source);
}
...
/**
  ...
  * @note Macro IS_TIM_BREAKSOURCE_INSTANCE(TIMx) can be used to check whether
  *       or not a timer instance allows for break input selection.
  * @rmtoll BRK          BKINE         LL_TIM_DisableBreakInputSource\n
  *         BRK          BKCMP1E       LL_TIM_DisableBreakInputSource\n
  *         BRK          BKCMP2E       LL_TIM_DisableBreakInputSource\n
  *         BRK          BKCMP3E       LL_TIM_DisableBreakInputSource\n
  *         BRK2          BK2INE        LL_TIM_DisableBreakInputSource\n
  *         BRK2          BK2CMP1E      LL_TIM_DisableBreakInputSource\n
  *         BRK2          BK2CMP2E      LL_TIM_DisableBreakInputSource\n
  *         BRK2          BK2CMP3E      LL_TIM_DisableBreakInputSource
  * @param  TIMx Timer instance
  * @param  BreakInput This parameter can be one of the following values:
  *         @arg @ref LL_TIM_BREAK_INPUT_BKIN
  *         @arg @ref LL_TIM_BREAK_INPUT_BKIN2
...
/**
  ...
  * @note Macro IS_TIM_BREAKSOURCE_INSTANCE(TIMx) can be used to check whether
  *       or not a timer instance allows for break input selection.
  * @rmtoll BRK          BKINP         LL_TIM_SetBreakInputSourcePolarity\n
  *         BRK          BKCMP1P       LL_TIM_SetBreakInputSourcePolarity\n
  *         BRK          BKCMP2P       LL_TIM_SetBreakInputSourcePolarity\n
  *         BRK          BKCMP3P       LL_TIM_SetBreakInputSourcePolarity\n
  *         BRK2          BK2INP        LL_TIM_SetBreakInputSourcePolarity\n
  *         BRK2          BK2CMP1P      LL_TIM_SetBreakInputSourcePolarity\n
  *         BRK2          BK2CMP2P      LL_TIM_SetBreakInputSourcePolarity\n
  *         BRK2          BK2CMP3P      LL_TIM_SetBreakInputSourcePolarity
  * @param  TIMx Timer instance
  * @param  BreakInput This parameter can be one of the following values:
  *         @arg @ref LL_TIM_BREAK_INPUT_BKIN
  *         @arg @ref LL_TIM_BREAK_INPUT_BKIN2
...
/**
  ...
  * @rmtoll DMAC          DBL           LL_TIM_ConfigDMABurst\n
  *         DMAC          DBA           LL_TIM_ConfigDMABurst
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->DMAC, (TIM_DCR_DBL | TIM_DCR_DBA), (DMABurstBaseAddress | DMABurstLength));
}
...
/**
  ...
  *         Otherwise see Reference Manual description of ISCLT registers.
  *
...
{
  MODIFY_REG(TIMx->ISCLT, (TIM_TISEL_TI1SEL | TIM_TISEL_TI2SEL | TIM_TISEL_TI3SEL | TIM_TISEL_TI4SEL), Remap);
}
...
/**
  ...
  * @rmtoll SLVMD          OCCS                LL_TIM_SetOCRefClearInputSource
  * @rmtoll AUX           OCREF_CLR           LL_TIM_SetOCRefClearInputSource
  * @param  TIMx Timer instance
...
{
  MODIFY_REG(TIMx->SLVMD, TIM_SMCR_OCCS,
             ((OCRefClearInputSource & OCREF_CLEAR_SELECT_Msk) >> OCREF_CLEAR_SELECT_Pos) << TIM_SMCR_OCCS_Pos);
  MODIFY_REG(TIMx->AUX, TIM1_OR1_OCREF_CLR, OCRefClearInputSource);
}
/**
  * @}
  */
...
/**
  ...
  * @rmtoll STATUS           UIF           LL_TIM_ClearFlag_UPDATE
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_UPDATE(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_UIF));
}

/**
  * @brief  Indicate whether update interrupt flag (UIF) is set (update interrupt is pending).
  * @rmtoll STATUS           UIF           LL_TIM_IsActiveFlag_UPDATE
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_UPDATE(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_UIF) == (TIM_SR_UIF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the Capture/Compare 1 interrupt flag (CC1F).
  * @rmtoll STATUS           CC1IF         LL_TIM_ClearFlag_CC1
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_CC1(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_CC1IF));
}

/**
  * @brief  Indicate whether Capture/Compare 1 interrupt flag (CC1F) is set (Capture/Compare 1 interrupt is pending).
  * @rmtoll STATUS           CC1IF         LL_TIM_IsActiveFlag_CC1
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_CC1(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_CC1IF) == (TIM_SR_CC1IF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the Capture/Compare 2 interrupt flag (CC2F).
  * @rmtoll STATUS           CC2IF         LL_TIM_ClearFlag_CC2
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_CC2(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_CC2IF));
}

/**
  * @brief  Indicate whether Capture/Compare 2 interrupt flag (CC2F) is set (Capture/Compare 2 interrupt is pending).
  * @rmtoll STATUS           CC2IF         LL_TIM_IsActiveFlag_CC2
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_CC2(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_CC2IF) == (TIM_SR_CC2IF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the Capture/Compare 3 interrupt flag (CC3F).
  * @rmtoll STATUS           CC3IF         LL_TIM_ClearFlag_CC3
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_CC3(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_CC3IF));
}

/**
  * @brief  Indicate whether Capture/Compare 3 interrupt flag (CC3F) is set (Capture/Compare 3 interrupt is pending).
  * @rmtoll STATUS           CC3IF         LL_TIM_IsActiveFlag_CC3
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_CC3(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_CC3IF) == (TIM_SR_CC3IF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the Capture/Compare 4 interrupt flag (CC4F).
  * @rmtoll STATUS           CC4IF         LL_TIM_ClearFlag_CC4
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_CC4(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_CC4IF));
}

/**
  * @brief  Indicate whether Capture/Compare 4 interrupt flag (CC4F) is set (Capture/Compare 4 interrupt is pending).
  * @rmtoll STATUS           CC4IF         LL_TIM_IsActiveFlag_CC4
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_CC4(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_CC4IF) == (TIM_SR_CC4IF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the Capture/Compare 5 interrupt flag (CC5F).
  * @rmtoll STATUS           CC5IF         LL_TIM_ClearFlag_CC5
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_CC5(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_CC5IF));
}

/**
  * @brief  Indicate whether Capture/Compare 5 interrupt flag (CC5F) is set (Capture/Compare 5 interrupt is pending).
  * @rmtoll STATUS           CC5IF         LL_TIM_IsActiveFlag_CC5
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_CC5(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_CC5IF) == (TIM_SR_CC5IF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the Capture/Compare 6 interrupt flag (CC6F).
  * @rmtoll STATUS           CC6IF         LL_TIM_ClearFlag_CC6
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_CC6(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_CC6IF));
}

/**
  * @brief  Indicate whether Capture/Compare 6 interrupt flag (CC6F) is set (Capture/Compare 6 interrupt is pending).
  * @rmtoll STATUS           CC6IF         LL_TIM_IsActiveFlag_CC6
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_CC6(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_CC6IF) == (TIM_SR_CC6IF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the commutation interrupt flag (COMIF).
  * @rmtoll STATUS           COMIF         LL_TIM_ClearFlag_COM
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_COM(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_COMIF));
}

/**
  * @brief  Indicate whether commutation interrupt flag (COMIF) is set (commutation interrupt is pending).
  * @rmtoll STATUS           COMIF         LL_TIM_IsActiveFlag_COM
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_COM(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_COMIF) == (TIM_SR_COMIF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the trigger interrupt flag (TIF).
  * @rmtoll STATUS           TIF           LL_TIM_ClearFlag_TRIG
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_TRIG(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_TIF));
}

/**
  * @brief  Indicate whether trigger interrupt flag (TIF) is set (trigger interrupt is pending).
  * @rmtoll STATUS           TIF           LL_TIM_IsActiveFlag_TRIG
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_TRIG(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_TIF) == (TIM_SR_TIF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the break interrupt flag (BIF).
  * @rmtoll STATUS           BIF           LL_TIM_ClearFlag_BRK
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_BRK(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_BIF));
}

/**
  * @brief  Indicate whether break interrupt flag (BIF) is set (break interrupt is pending).
  * @rmtoll STATUS           BIF           LL_TIM_IsActiveFlag_BRK
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_BRK(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_BIF) == (TIM_SR_BIF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the break 2 interrupt flag (B2IF).
  * @rmtoll STATUS           B2IF          LL_TIM_ClearFlag_BRK2
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_BRK2(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_B2IF));
}

/**
  * @brief  Indicate whether break 2 interrupt flag (B2IF) is set (break 2 interrupt is pending).
  * @rmtoll STATUS           B2IF          LL_TIM_IsActiveFlag_BRK2
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_BRK2(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_B2IF) == (TIM_SR_B2IF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the Capture/Compare 1 over-capture interrupt flag (CC1OF).
  * @rmtoll STATUS           CC1OF         LL_TIM_ClearFlag_CC1OVR
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_CC1OVR(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_CC1OF));
}

/**
  * @brief  Indicate whether Capture/Compare 1 over-capture interrupt flag (CC1OF) is set
  *         (Capture/Compare 1 interrupt is pending).
  * @rmtoll STATUS           CC1OF         LL_TIM_IsActiveFlag_CC1OVR
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_CC1OVR(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_CC1OF) == (TIM_SR_CC1OF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the Capture/Compare 2 over-capture interrupt flag (CC2OF).
  * @rmtoll STATUS           CC2OF         LL_TIM_ClearFlag_CC2OVR
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_CC2OVR(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_CC2OF));
}

/**
  * @brief  Indicate whether Capture/Compare 2 over-capture interrupt flag (CC2OF) is set
  *         (Capture/Compare 2 over-capture interrupt is pending).
  * @rmtoll STATUS           CC2OF         LL_TIM_IsActiveFlag_CC2OVR
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_CC2OVR(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_CC2OF) == (TIM_SR_CC2OF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the Capture/Compare 3 over-capture interrupt flag (CC3OF).
  * @rmtoll STATUS           CC3OF         LL_TIM_ClearFlag_CC3OVR
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_CC3OVR(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_CC3OF));
}

/**
  * @brief  Indicate whether Capture/Compare 3 over-capture interrupt flag (CC3OF) is set
  *         (Capture/Compare 3 over-capture interrupt is pending).
  * @rmtoll STATUS           CC3OF         LL_TIM_IsActiveFlag_CC3OVR
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_CC3OVR(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_CC3OF) == (TIM_SR_CC3OF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the Capture/Compare 4 over-capture interrupt flag (CC4OF).
  * @rmtoll STATUS           CC4OF         LL_TIM_ClearFlag_CC4OVR
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_CC4OVR(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_CC4OF));
}

/**
  * @brief  Indicate whether Capture/Compare 4 over-capture interrupt flag (CC4OF) is set
  *         (Capture/Compare 4 over-capture interrupt is pending).
  * @rmtoll STATUS           CC4OF         LL_TIM_IsActiveFlag_CC4OVR
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_CC4OVR(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_CC4OF) == (TIM_SR_CC4OF)) ? 1UL : 0UL);
}

/**
  * @brief  Clear the system break interrupt flag (SBIF).
  * @rmtoll STATUS           SBIF          LL_TIM_ClearFlag_SYSBRK
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_ClearFlag_SYSBRK(TIM_TypeDef *TIMx)
{
  WRITE_REG(TIMx->STATUS, ~(TIM_SR_SBIF));
}

/**
  * @brief  Indicate whether system break interrupt flag (SBIF) is set (system break interrupt is pending).
  * @rmtoll STATUS           SBIF          LL_TIM_IsActiveFlag_SYSBRK
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsActiveFlag_SYSBRK(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->STATUS, TIM_SR_SBIF) == (TIM_SR_SBIF)) ? 1UL : 0UL);
}
...
/**
  ...
  * @rmtoll REQEN         UIE           LL_TIM_EnableIT_UPDATE
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableIT_UPDATE(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_UIE);
}

/**
  * @brief  Disable update interrupt (UIE).
  * @rmtoll REQEN         UIE           LL_TIM_DisableIT_UPDATE
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableIT_UPDATE(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_UIE);
}

/**
  * @brief  Indicates whether the update interrupt (UIE) is enabled.
  * @rmtoll REQEN         UIE           LL_TIM_IsEnabledIT_UPDATE
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledIT_UPDATE(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_UIE) == (TIM_DIER_UIE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable capture/compare 1 interrupt (CC1IE).
  * @rmtoll REQEN         CC1IE         LL_TIM_EnableIT_CC1
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableIT_CC1(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_CC1IE);
}

/**
  * @brief  Disable capture/compare 1  interrupt (CC1IE).
  * @rmtoll REQEN         CC1IE         LL_TIM_DisableIT_CC1
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableIT_CC1(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_CC1IE);
}

/**
  * @brief  Indicates whether the capture/compare 1 interrupt (CC1IE) is enabled.
  * @rmtoll REQEN         CC1IE         LL_TIM_IsEnabledIT_CC1
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledIT_CC1(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_CC1IE) == (TIM_DIER_CC1IE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable capture/compare 2 interrupt (CC2IE).
  * @rmtoll REQEN         CC2IE         LL_TIM_EnableIT_CC2
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableIT_CC2(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_CC2IE);
}

/**
  * @brief  Disable capture/compare 2  interrupt (CC2IE).
  * @rmtoll REQEN         CC2IE         LL_TIM_DisableIT_CC2
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableIT_CC2(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_CC2IE);
}

/**
  * @brief  Indicates whether the capture/compare 2 interrupt (CC2IE) is enabled.
  * @rmtoll REQEN         CC2IE         LL_TIM_IsEnabledIT_CC2
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledIT_CC2(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_CC2IE) == (TIM_DIER_CC2IE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable capture/compare 3 interrupt (CC3IE).
  * @rmtoll REQEN         CC3IE         LL_TIM_EnableIT_CC3
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableIT_CC3(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_CC3IE);
}

/**
  * @brief  Disable capture/compare 3  interrupt (CC3IE).
  * @rmtoll REQEN         CC3IE         LL_TIM_DisableIT_CC3
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableIT_CC3(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_CC3IE);
}

/**
  * @brief  Indicates whether the capture/compare 3 interrupt (CC3IE) is enabled.
  * @rmtoll REQEN         CC3IE         LL_TIM_IsEnabledIT_CC3
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledIT_CC3(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_CC3IE) == (TIM_DIER_CC3IE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable capture/compare 4 interrupt (CC4IE).
  * @rmtoll REQEN         CC4IE         LL_TIM_EnableIT_CC4
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableIT_CC4(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_CC4IE);
}

/**
  * @brief  Disable capture/compare 4  interrupt (CC4IE).
  * @rmtoll REQEN         CC4IE         LL_TIM_DisableIT_CC4
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableIT_CC4(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_CC4IE);
}

/**
  * @brief  Indicates whether the capture/compare 4 interrupt (CC4IE) is enabled.
  * @rmtoll REQEN         CC4IE         LL_TIM_IsEnabledIT_CC4
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledIT_CC4(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_CC4IE) == (TIM_DIER_CC4IE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable commutation interrupt (COMIE).
  * @rmtoll REQEN         COMIE         LL_TIM_EnableIT_COM
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableIT_COM(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_COMIE);
}

/**
  * @brief  Disable commutation interrupt (COMIE).
  * @rmtoll REQEN         COMIE         LL_TIM_DisableIT_COM
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableIT_COM(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_COMIE);
}

/**
  * @brief  Indicates whether the commutation interrupt (COMIE) is enabled.
  * @rmtoll REQEN         COMIE         LL_TIM_IsEnabledIT_COM
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledIT_COM(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_COMIE) == (TIM_DIER_COMIE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable trigger interrupt (TIE).
  * @rmtoll REQEN         TIE           LL_TIM_EnableIT_TRIG
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableIT_TRIG(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_TIE);
}

/**
  * @brief  Disable trigger interrupt (TIE).
  * @rmtoll REQEN         TIE           LL_TIM_DisableIT_TRIG
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableIT_TRIG(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_TIE);
}

/**
  * @brief  Indicates whether the trigger interrupt (TIE) is enabled.
  * @rmtoll REQEN         TIE           LL_TIM_IsEnabledIT_TRIG
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledIT_TRIG(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_TIE) == (TIM_DIER_TIE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable break interrupt (BIE).
  * @rmtoll REQEN         BIE           LL_TIM_EnableIT_BRK
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableIT_BRK(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_BIE);
}

/**
  * @brief  Disable break interrupt (BIE).
  * @rmtoll REQEN         BIE           LL_TIM_DisableIT_BRK
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableIT_BRK(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_BIE);
}

/**
  * @brief  Indicates whether the break interrupt (BIE) is enabled.
  * @rmtoll REQEN         BIE           LL_TIM_IsEnabledIT_BRK
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledIT_BRK(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_BIE) == (TIM_DIER_BIE)) ? 1UL : 0UL);
}
...
/**
  ...
  * @rmtoll REQEN         UDE           LL_TIM_EnableDMAReq_UPDATE
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableDMAReq_UPDATE(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_UDE);
}

/**
  * @brief  Disable update DMA request (UDE).
  * @rmtoll REQEN         UDE           LL_TIM_DisableDMAReq_UPDATE
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableDMAReq_UPDATE(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_UDE);
}

/**
  * @brief  Indicates whether the update DMA request  (UDE) is enabled.
  * @rmtoll REQEN         UDE           LL_TIM_IsEnabledDMAReq_UPDATE
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledDMAReq_UPDATE(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_UDE) == (TIM_DIER_UDE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable capture/compare 1 DMA request (CC1DE).
  * @rmtoll REQEN         CC1DE         LL_TIM_EnableDMAReq_CC1
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableDMAReq_CC1(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_CC1DE);
}

/**
  * @brief  Disable capture/compare 1  DMA request (CC1DE).
  * @rmtoll REQEN         CC1DE         LL_TIM_DisableDMAReq_CC1
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableDMAReq_CC1(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_CC1DE);
}

/**
  * @brief  Indicates whether the capture/compare 1 DMA request (CC1DE) is enabled.
  * @rmtoll REQEN         CC1DE         LL_TIM_IsEnabledDMAReq_CC1
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledDMAReq_CC1(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_CC1DE) == (TIM_DIER_CC1DE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable capture/compare 2 DMA request (CC2DE).
  * @rmtoll REQEN         CC2DE         LL_TIM_EnableDMAReq_CC2
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableDMAReq_CC2(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_CC2DE);
}

/**
  * @brief  Disable capture/compare 2  DMA request (CC2DE).
  * @rmtoll REQEN         CC2DE         LL_TIM_DisableDMAReq_CC2
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableDMAReq_CC2(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_CC2DE);
}

/**
  * @brief  Indicates whether the capture/compare 2 DMA request (CC2DE) is enabled.
  * @rmtoll REQEN         CC2DE         LL_TIM_IsEnabledDMAReq_CC2
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledDMAReq_CC2(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_CC2DE) == (TIM_DIER_CC2DE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable capture/compare 3 DMA request (CC3DE).
  * @rmtoll REQEN         CC3DE         LL_TIM_EnableDMAReq_CC3
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableDMAReq_CC3(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_CC3DE);
}

/**
  * @brief  Disable capture/compare 3  DMA request (CC3DE).
  * @rmtoll REQEN         CC3DE         LL_TIM_DisableDMAReq_CC3
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableDMAReq_CC3(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_CC3DE);
}

/**
  * @brief  Indicates whether the capture/compare 3 DMA request (CC3DE) is enabled.
  * @rmtoll REQEN         CC3DE         LL_TIM_IsEnabledDMAReq_CC3
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledDMAReq_CC3(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_CC3DE) == (TIM_DIER_CC3DE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable capture/compare 4 DMA request (CC4DE).
  * @rmtoll REQEN         CC4DE         LL_TIM_EnableDMAReq_CC4
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableDMAReq_CC4(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_CC4DE);
}

/**
  * @brief  Disable capture/compare 4  DMA request (CC4DE).
  * @rmtoll REQEN         CC4DE         LL_TIM_DisableDMAReq_CC4
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableDMAReq_CC4(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_CC4DE);
}

/**
  * @brief  Indicates whether the capture/compare 4 DMA request (CC4DE) is enabled.
  * @rmtoll REQEN         CC4DE         LL_TIM_IsEnabledDMAReq_CC4
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledDMAReq_CC4(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_CC4DE) == (TIM_DIER_CC4DE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable commutation DMA request (COMDE).
  * @rmtoll REQEN         COMDE         LL_TIM_EnableDMAReq_COM
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableDMAReq_COM(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_COMDE);
}

/**
  * @brief  Disable commutation DMA request (COMDE).
  * @rmtoll REQEN         COMDE         LL_TIM_DisableDMAReq_COM
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableDMAReq_COM(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_COMDE);
}

/**
  * @brief  Indicates whether the commutation DMA request (COMDE) is enabled.
  * @rmtoll REQEN         COMDE         LL_TIM_IsEnabledDMAReq_COM
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledDMAReq_COM(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_COMDE) == (TIM_DIER_COMDE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable trigger interrupt (TDE).
  * @rmtoll REQEN         TDE           LL_TIM_EnableDMAReq_TRIG
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_EnableDMAReq_TRIG(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->REQEN, TIM_DIER_TDE);
}

/**
  * @brief  Disable trigger interrupt (TDE).
  * @rmtoll REQEN         TDE           LL_TIM_DisableDMAReq_TRIG
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_DisableDMAReq_TRIG(TIM_TypeDef *TIMx)
{
  CLEAR_BIT(TIMx->REQEN, TIM_DIER_TDE);
}

/**
  * @brief  Indicates whether the trigger interrupt (TDE) is enabled.
  * @rmtoll REQEN         TDE           LL_TIM_IsEnabledDMAReq_TRIG
  * @param  TIMx Timer instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_TIM_IsEnabledDMAReq_TRIG(TIM_TypeDef *TIMx)
{
  return ((READ_BIT(TIMx->REQEN, TIM_DIER_TDE) == (TIM_DIER_TDE)) ? 1UL : 0UL);
}
...
/**
  ...
  * @rmtoll EVT          UG            LL_TIM_GenerateEvent_UPDATE
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_GenerateEvent_UPDATE(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->EVT, TIM_EGR_UG);
}

/**
  * @brief  Generate Capture/Compare 1 event.
  * @rmtoll EVT          CC1G          LL_TIM_GenerateEvent_CC1
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_GenerateEvent_CC1(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->EVT, TIM_EGR_CC1G);
}

/**
  * @brief  Generate Capture/Compare 2 event.
  * @rmtoll EVT          CC2G          LL_TIM_GenerateEvent_CC2
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_GenerateEvent_CC2(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->EVT, TIM_EGR_CC2G);
}

/**
  * @brief  Generate Capture/Compare 3 event.
  * @rmtoll EVT          CC3G          LL_TIM_GenerateEvent_CC3
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_GenerateEvent_CC3(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->EVT, TIM_EGR_CC3G);
}

/**
  * @brief  Generate Capture/Compare 4 event.
  * @rmtoll EVT          CC4G          LL_TIM_GenerateEvent_CC4
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_GenerateEvent_CC4(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->EVT, TIM_EGR_CC4G);
}

/**
  * @brief  Generate commutation event.
  * @rmtoll EVT          COMG          LL_TIM_GenerateEvent_COM
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_GenerateEvent_COM(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->EVT, TIM_EGR_COMG);
}

/**
  * @brief  Generate trigger event.
  * @rmtoll EVT          TG            LL_TIM_GenerateEvent_TRIG
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_GenerateEvent_TRIG(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->EVT, TIM_EGR_TG);
}

/**
  * @brief  Generate break event.
  * @rmtoll EVT          BG            LL_TIM_GenerateEvent_BRK
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_GenerateEvent_BRK(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->EVT, TIM_EGR_BG);
}

/**
  * @brief  Generate break 2 event.
  * @rmtoll EVT          B2G           LL_TIM_GenerateEvent_BRK2
  * @param  TIMx Timer instance
  */
__STATIC_INLINE void LL_TIM_GenerateEvent_BRK2(TIM_TypeDef *TIMx)
{
  SET_BIT(TIMx->EVT, TIM_EGR_B2G);
}
