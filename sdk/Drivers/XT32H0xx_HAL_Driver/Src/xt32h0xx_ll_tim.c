...
ErrorStatus LL_TIM_Init(TIM_TypeDef *TIMx, LL_TIM_InitTypeDef *TIM_InitStruct)
{
  ...
  tmpcr1 = LL_TIM_ReadReg(TIMx, CTRL1);
  ...
  /* Write to TIMx CTRL1 */
  LL_TIM_WriteReg(TIMx, CTRL1, tmpcr1);
...
void LL_TIM_OC_StructInit(LL_TIM_OC_InitTypeDef *TIM_OC_InitStruct)
{
  ...
  TIM_OC_InitStruct->OCDeadTime   = 0;
  TIM_OC_InitStruct->OCNDeadTime  = 0;
}
...
ErrorStatus LL_TIM_ENCODER_Init(TIM_TypeDef *TIMx, LL_TIM_ENCODER_InitTypeDef *TIM_EncoderInitStruct)
{
  ...
  TIMx->CHEP &= (uint32_t)~(TIM_CCER_CC1E | TIM_CCER_CC2E);

  /* Get the TIMx CHMD1 register value */
  tmpccmr1 = LL_TIM_ReadReg(TIMx, CHMD1);

  /* Get the TIMx CHEP register value */
  tmpccer = LL_TIM_ReadReg(TIMx, CHEP);
  ...
  /* Write to TIMx CHMD1 */
  LL_TIM_WriteReg(TIMx, CHMD1, tmpccmr1);

  /* Write to TIMx CHEP */
  LL_TIM_WriteReg(TIMx, CHEP, tmpccer);
...
ErrorStatus LL_TIM_HALLSENSOR_Init(TIM_TypeDef *TIMx, LL_TIM_HALLSENSOR_InitTypeDef *TIM_HallSensorInitStruct)
{
  ...
  tmpcr2 = LL_TIM_ReadReg(TIMx, CTRL2);
  ...
  tmpsmcr = LL_TIM_ReadReg(TIMx, SLVMD);
  ...
  /* Write to TIMx CTRL2 */
  LL_TIM_WriteReg(TIMx, CTRL2, tmpcr2);

  /* Write to TIMx SLVMD */
  LL_TIM_WriteReg(TIMx, SLVMD, tmpsmcr);
...
//  MODIFY_REG(tmpbdtr, TIM_BDTR_DTG, TIM_BDTRInitStruct->DeadTime);
  ...
  if (IS_TIM_BKIN2_INSTANCE(TIMx))
  {
    ...
    /* Set the BREAK2 input related BKDT bit-fields */
  ...
  /* Set TIMx_BDTR */
  LL_TIM_WriteReg(TIMx, BKDT, tmpbdtr);
...
static ErrorStatus OC1Config(TIM_TypeDef *TIMx, LL_TIM_OC_InitTypeDef *TIM_OCInitStruct)
{
  ...
  CLEAR_BIT(TIMx->CHEP, TIM_CCER_CC1E);
  ...
  /* Set dead time */
  tmpdtr = LL_TIM_ReadReg(TIMx, DTR1);
  MODIFY_REG(tmpdtr, TIM_DTR_DTG1P, (TIM_OCInitStruct->OCDeadTime << TIM_DTR_DTG1P_Pos));
  MODIFY_REG(tmpdtr, TIM_DTR_DTG1N, (TIM_OCInitStruct->OCNDeadTime << TIM_DTR_DTG1N_Pos));
  LL_TIM_WriteReg(TIMx, DTR1, tmpdtr);
...
static ErrorStatus OC2Config(TIM_TypeDef *TIMx, LL_TIM_OC_InitTypeDef *TIM_OCInitStruct)
{
  ...
  CLEAR_BIT(TIMx->CHEP, TIM_CCER_CC2E);
  ...
  /* Set dead time */
  tmpdtr = LL_TIM_ReadReg(TIMx, DTR1);
  MODIFY_REG(tmpdtr, TIM_DTR_DTG2P, (TIM_OCInitStruct->OCDeadTime << TIM_DTR_DTG2P_Pos));
  MODIFY_REG(tmpdtr, TIM_DTR_DTG2N, (TIM_OCInitStruct->OCNDeadTime << TIM_DTR_DTG2N_Pos));
  LL_TIM_WriteReg(TIMx, DTR1, tmpdtr);
...
static ErrorStatus OC3Config(TIM_TypeDef *TIMx, LL_TIM_OC_InitTypeDef *TIM_OCInitStruct)
{
  ...
  CLEAR_BIT(TIMx->CHEP, TIM_CCER_CC3E);
  ...
  tmpccmr2 = LL_TIM_ReadReg(TIMx, CHMD2);
  ...
  /* Write to TIMx CHMD2 */
  LL_TIM_WriteReg(TIMx, CHMD2, tmpccmr2);
  ...
  /* Set dead time */
  tmpdtr = LL_TIM_ReadReg(TIMx, DTR2);
  MODIFY_REG(tmpdtr, TIM_DTR_DTG3P, (TIM_OCInitStruct->OCDeadTime << TIM_DTR_DTG3P_Pos));
  MODIFY_REG(tmpdtr, TIM_DTR_DTG3N, (TIM_OCInitStruct->OCNDeadTime << TIM_DTR_DTG3N_Pos));
  LL_TIM_WriteReg(TIMx, DTR2, tmpdtr);
...
static ErrorStatus OC4Config(TIM_TypeDef *TIMx, LL_TIM_OC_InitTypeDef *TIM_OCInitStruct)
{
  ...
  CLEAR_BIT(TIMx->CHEP, TIM_CCER_CC4E);
...
static ErrorStatus OC5Config(TIM_TypeDef *TIMx, LL_TIM_OC_InitTypeDef *TIM_OCInitStruct)
{
  ...
  CLEAR_BIT(TIMx->CHEP, TIM_CCER_CC5E);

  /* Get the TIMx CHEP register value */
  tmpccer = LL_TIM_ReadReg(TIMx, CHEP);

  /* Get the TIMx CHMD3 register value */
  tmpccmr3 = LL_TIM_ReadReg(TIMx, CHMD3);
  ...
  if (IS_TIM_BREAK_INSTANCE(TIMx))
  {
    ...
    /* Set the Output Idle state */
    MODIFY_REG(TIMx->CTRL2, TIM_CR2_OIS5, TIM_OCInitStruct->OCIdleState << 8U);

  }

  /* Write to TIMx CHMD3 */
  LL_TIM_WriteReg(TIMx, CHMD3, tmpccmr3);
...
static ErrorStatus OC6Config(TIM_TypeDef *TIMx, LL_TIM_OC_InitTypeDef *TIM_OCInitStruct)
{
  ...
  CLEAR_BIT(TIMx->CHEP, TIM_CCER_CC6E);
  ...
  if (IS_TIM_BREAK_INSTANCE(TIMx))
  {
    ...
    /* Set the Output Idle state */
    MODIFY_REG(TIMx->CTRL2, TIM_CR2_OIS6, TIM_OCInitStruct->OCIdleState << 10U);
  }
...
static ErrorStatus IC1Config(TIM_TypeDef *TIMx, LL_TIM_IC_InitTypeDef *TIM_ICInitStruct)
{
  ...
  /* Disable the Channel 1: Reset the CC1E Bit */
  TIMx->CHEP &= (uint32_t)~TIM_CCER_CC1E;

  /* Select the Input and set the filter and the prescaler value */
  MODIFY_REG(TIMx->CHMD1,
             (TIM_CCMR1_CC1S | TIM_CCMR1_IC1F | TIM_CCMR1_IC1PSC),
             (TIM_ICInitStruct->ICActiveInput | TIM_ICInitStruct->ICFilter | TIM_ICInitStruct->ICPrescaler) >> 16U);

  /* Select the Polarity and set the CC1E Bit */
  MODIFY_REG(TIMx->CHEP,
...
static ErrorStatus IC2Config(TIM_TypeDef *TIMx, LL_TIM_IC_InitTypeDef *TIM_ICInitStruct)
{
  ...
  /* Disable the Channel 2: Reset the CC2E Bit */
  TIMx->CHEP &= (uint32_t)~TIM_CCER_CC2E;
...
static ErrorStatus IC3Config(TIM_TypeDef *TIMx, LL_TIM_IC_InitTypeDef *TIM_ICInitStruct)
{
  ...
  /* Disable the Channel 3: Reset the CC3E Bit */
  TIMx->CHEP &= (uint32_t)~TIM_CCER_CC3E;

  /* Select the Input and set the filter and the prescaler value */
  MODIFY_REG(TIMx->CHMD2,
...
static ErrorStatus IC4Config(TIM_TypeDef *TIMx, LL_TIM_IC_InitTypeDef *TIM_ICInitStruct)
{
  ...
  /* Disable the Channel 4: Reset the CC4E Bit */
  TIMx->CHEP &= (uint32_t)~TIM_CCER_CC4E;
